...
public class RayoScriptLevel4 : MonoBehaviour {
    ...
    void FixedUpdate()
    {
        ...
        KnightScript1Four Knight1Script = Knight1.GetComponent<KnightScript1Four>();
        GameObject Knight2 = GameObject.Find("Knight2");
        KnightScript2Four Knight2Script = Knight2.GetComponent<KnightScript2Four>();
